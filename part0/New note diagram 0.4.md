...
activate Server
Server-->>Browser: The css file with HTTP Status Code 304
deactivate Server

Note over Browser,Server: HTTP Status Code 304 (Not modifies) <br/>says that the file is not modified and cache version can be used


Browser->>Server: GET https://studies.cs.helsinki.fi/exampleapp/main.js
activate Server
Server-->>Browser: The JavaScript file with HTTP Status Code 304
deactivate Server
